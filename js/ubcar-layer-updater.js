...
function goToLayers() {
	...
	desiredPage = escapeHTML( jQuery( '#ubcar-layer-choose-count' ).val() );
	if( desiredPage > escapeHTML( jQuery( '#ubcar-layer-max-count' ).html() ) ) {
		desiredPage = escapeHTML( jQuery( '#ubcar-layer-max-count' ).html() );
