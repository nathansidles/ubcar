...
function goToPoints() {
	...
	desiredPage = escapeHTML( jQuery( '#ubcar-point-choose-count' ).val() );
	if( desiredPage > escapeHTML( jQuery( '#ubcar-point-max-count' ).html() ) ) {
		desiredPage = escapeHTML( jQuery( '#ubcar-point-max-count' ).html() );
