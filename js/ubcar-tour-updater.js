...
function goToTours() {
	...
	desiredPage = escapeHTML( jQuery( '#ubcar-tour-choose-count' ).val() );
	if( desiredPage > escapeHTML( jQuery( '#ubcar-tour-max-count' ).html() ) ) {
		desiredPage = escapeHTML( jQuery( '#ubcar-tour-max-count' ).html() );
